...
const BLOG = {
  AUTHOR: 'nygula', // 作者
  BIO: '风行口袋🍚', // 作者简介
  LINK: 'https://www.dzs7.com', // 网站地址
  KEYWORDS: 'dzs7, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'd4c63458cdaa49c99296e6cd5b09fb5a', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'l-y-8@qq.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/nygula',
  CONTACT_TELEGRAM: '',
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '大战时7', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '站点更新中', // 站点描述，被notion中的页面描述覆盖
